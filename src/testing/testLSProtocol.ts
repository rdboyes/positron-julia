...
// (import changed from vscode-languageserver-protocol to vscode-languageclient)
...
export const notifyTypeTextDocumentPublishTests =
    new lsp.ProtocolNotificationType<PublishTestsParams, void>('julia/publishTests');
...
export const requestTypeJuliaGetTestEnv =
    new lsp.ProtocolRequestType<{ uri: string }, GetTestEnvRequestParamsReturn, void, void, void>('julia/getTestEnv');
